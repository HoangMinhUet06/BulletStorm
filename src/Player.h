...
private:
    ...
    static const int ANIMATION_DELAY = 400;    // t mỗi frame
    static constexpr float JUMP_HEIGHT = 50;
    static constexpr float JUMP_VELOCITY = -4.0f;
    static constexpr float GRAVITY = 0.1f;
    static constexpr float MOVE_SPEED = 0.4f;
...
public:
    ...
    void incrementScore(int points); // Tăng điểm cho người chơi
